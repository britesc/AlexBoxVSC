...
""" Create and Display Battery System. """
def display_power():
    # Create an ADS1115 ADC (16-bit) instance.
    gc.enable()    
    ina219 = INA219(addr=0x43)
    gui.display_boxes(0,255,255,"c","Power / UPS","power.565")    

    gui.display.upscaled_text(5,55, "Power / UPS System:",gui.display.color(0,255,255),upscaling=2)
    ...
    vol = "Voltage:  {:6.3f} V".format(bus_voltage)
    cur = "Current:  {:6.3f} A".format(current/1000)
    per = "Percent:  {:6.1f} %".format(P)
